...
import { FactoryLicenceDetailViewModel } from '../../licences-typed-models';
...
export class FactoryLicenceDetailComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, 
    ...
    initViewData(genericFormData: GenericFormModel<FactoryLicenceDetailViewModel>) {
