...
@Component({
    selector: 'app-app-treasury-wise-payment-manager',
    templateUrl: './app-treasury-wise-payment-manager.component.html',
    styleUrls: ['./app-treasury-wise-payment-manager.component.css'],
    standalone: false
})
export class AppTreasuryWisePaymentManagerComponent implements OnInit {
  protected ngUnsubscribe: Subject<void> = new Subject<void>();
  public parmamEncodedinfo:string;
  public paramInfo:any;
  public paymentPartDetail: IAppPaymentPartsDetailViewModel;
  public appRefId : any;
  public feeHeadersSortOrder: number[] = [19];
