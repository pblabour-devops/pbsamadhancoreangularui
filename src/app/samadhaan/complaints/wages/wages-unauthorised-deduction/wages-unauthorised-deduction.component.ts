...
@Component({
  selector: 'app-wages-unauthorised-deduction',
  standalone: false,
  templateUrl: './wages-unauthorised-deduction.component.html',
  styleUrl: './wages-unauthorised-deduction.component.css',
})
export class WagesUnauthorisedDeductionComponent {
