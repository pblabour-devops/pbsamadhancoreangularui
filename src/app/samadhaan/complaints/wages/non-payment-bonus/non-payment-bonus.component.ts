...
@Component({
  selector: 'app-non-payment-bonus',
  standalone: false,
  templateUrl: './non-payment-bonus.component.html',
  styleUrl: './non-payment-bonus.component.css',
})
export class NonPaymentBonusComponent {
