...
protected ngUnsubscribe: Subject<void> = new Subject<void>();
   ...
   Input_Form: TForm<IComplaint_Claim_CodeOnWage> = this.fb.group(
    {
      ...
      applicationType : [10001, Validators.required]
    },
    {
  ...
  this.Input_Form.controls.rootActivityRefId.patchValue('default value');
  ...
  this.appHttpRequestHandlerService
    .httpPost(this.Input_Form.value,'pbsamadhannetcoreapi.Models.Complaint_Claim_CodeOnWage','Crud','CreateUpdate').pipe(takeUntil(this.ngUnsubscribe)).subscribe({
      next: () => {
