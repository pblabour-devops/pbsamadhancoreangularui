...
const routes: Routes = [
   ...
   {path : 'penality-code-on-wages',component : PenalityCodeOnWagesGeneralDetailsComponent},
   {path : 'penality-industrial-relations-code',component : PenalityCodeOnWagesBreachComponent}
];
