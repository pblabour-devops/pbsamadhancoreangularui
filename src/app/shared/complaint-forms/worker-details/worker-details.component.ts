...
import { WorkerFormModel } from 'src/app/dashboard/dashboard-typed-models';
...
import { ProjectSite } from 'src/app/applicationProcess/applicationProcess-typed-module';
...
export class WorkerDetailsComponent {
  ...
  onSubmit(): void {
    if (this.Input_Form.valid) {
        ...
        this.Input_Form.controls.projectSiteRefId.patchValue(388263);
  ...
  mapCategories(data : ICRUD_CreateUpdateOperationResponse) {
